...
public class DefaultKinematic extends KinematicModel {
    ...
    */ 
     ...
     protected void   update(double elapsedSecond,Transform3D rotation,Vector3d instantTranslation,Vector3d instantRotation, int direction) {
         
         if ( direction == 0 ) instantTranslation.set(translationalVelocity * elapsedSecond, 0.0, 0.0);
         if ( direction == 1 ) instantTranslation.set(translationalVelocity * elapsedSecond*(-1), 0.0, 0.0);
         if ( direction == 2 ) instantTranslation.set(0.0, 0.0, translationalVelocity * elapsedSecond);
         if ( direction == 3 ) instantTranslation.set(0.0, 0.0, translationalVelocity * elapsedSecond*(-1));
         // apply current rotation (on y axis)
         rotation.transform(instantTranslation);
