...
import ProjetCPOA.gui.AgentInspector;
import ProjetCPOA.gui.Console;
import ProjetCPOA.gui.ControlWindow;
...
public class Simbad extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		...
		//Robot robot = new Robot(new Vector3d(0, 0, 0), "Robot");
		//new Simbad(new MyEnv(robot), false);
	}
