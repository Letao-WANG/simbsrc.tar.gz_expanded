...
public class ControlWindow extends JInternalFrame {
	...
	private void createGui(World world, Simulator simulator) {
		...
		SimulatorControlGUI simulatorControlGUI = new SimulatorControlGUI((JFrame) getParent(), simulator);
		panel.add(simulatorControlGUI);
		panel.addKeyListener(simulatorControlGUI);
